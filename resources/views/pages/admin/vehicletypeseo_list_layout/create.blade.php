...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form id="countryForm" method="post" action="{{route('vehicletypeseo_list_layout_store', $country->id)}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('vehicletypeseo_list_layout_store', $country->id)}}', formData)
